...
const travelOptions = [
  {
    ...
    time: '58 min',
    cost: '$2.50',
    details: 'Walk 7 min, (500m) to One North MRT, Train from One North to Buona Vista 1 min (1 Stop), Train from Buona Vista to City Hall, then walk 10 min (600m)',
    sortKey: 58,
  },
  {
    id: 2,
    time: '1 hr 5 min',
    cost: '$2.00',
    details: 'Walk 15 min, (1.1km) to Buona Vista MRT, Train from Buona Vista to City Hall 15 min (6 Stops), then walk 10 min (600m) to Destination',
    sortKey: 65,
  },
  {
    id: 3,
