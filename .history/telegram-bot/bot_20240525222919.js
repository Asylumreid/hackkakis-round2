...
function sendMainMenu(chatId) {
  bot.sendMessage(chatId, 'Welcome to TravelBot! How can I assist you today? 🌏✨', {
    reply_markup: {
      inline_keyboard: [
...
function displayTravelOptions(chatId) {
  ...
  bot.sendMessage(chatId, `Here are your travel options: 🛣️\n${optionsText}`, {
    reply_markup: {
...
bot.on('message', (msg) => {
  ...
  if (currentState.stage === 'planningRouteStart') {
    ...
    bot.sendMessage(chatId, 'Please choose an option from the menu.', {  reply_markup: {
        inline_keyboard: [
          [{ text: 'Help 💡', callback_data: 'help' }],
          [{ text: 'Plan Route 🚀', callback_data: 'planroute' }],
          [{ text: 'Calculate Fees 💰', callback_data: 'calculatefees' }],
