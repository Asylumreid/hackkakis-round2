...
const travelOptions = [
  {
    ...
    time: '58 min',
    cost: '$2.50',
    details: 'Walk 7 min, 500m to One North MRT, Train from One North to Buona Vista 1 min (1 Stop), Train from Buona Vista to City Hall, then walk 10 min to Destination',
    sortKey: 58,
  },
  {
    id: 2,
