...
const travelOptions = [
  {
    ...
    time: '58 min',
    cost: '$2.50',
    details: 'Walk 7 min, 500m to One North MRT, Train from One North to Buona Vista (1 Stop),Bus 12 from Bus Stop A to Bus Stop B, then walk 10 min to Destination',
    sortKey: 58,
  },
  {
    id: 2,
