...
const travelOptions = [
  ...
  },
  {
    ...
    time: '1 hr 5 min',
    cost: '$2.00',
    details: 'Walk 15 min, (1.1km) to Buona Vista MRT, Train from Buona Vista to City Hall 15 min (6 Stops), then walk 10 min (600m) to SMU',
    sortKey: 65,
  },
  {
    id: 3,
    time: '1 hr 9 min',
    cost: '$1.80',
    details: 'Walk 7 min, (500m) to One North MRT, Train from One North to Bras Basah (20 Stops), Train from Buona Vista to City Hall, then walk 10 min (600m) to SMU',
    sortKey: 69,
  },
];
